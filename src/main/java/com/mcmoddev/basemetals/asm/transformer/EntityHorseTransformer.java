package com.mcmoddev.basemetals.asm.transformer;
			...
			if (methodNode.name.equals(dev ? "entityInit" : "func_70088_a")) {
				for (final AbstractInsnNode insnNode : methodNode.instructions.toArray())
					if (insnNode.getOpcode() == RETURN) {
						...
						inject.add(new MethodInsnNode(INVOKESTATIC, "com/mcmoddev/basemetals/asm/BaseMetalHooks",
				...
				inject.add(new MethodInsnNode(INVOKESTATIC, "com/mcmoddev/basemetals/asm/BaseMetalHooks", "setHorseArmorStack",
