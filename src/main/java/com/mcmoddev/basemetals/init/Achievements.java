			...
			if (metallurgy != null) {
				...
				if (Options.isMaterialEnabled(MaterialNames.MITHRIL)) {
					...
					final Achievement mithrilMaker = makeAchievement(AchievementNames.MITHRIL_MAKER,
							metallurgy, 11, 10, mithril.getItem(Names.INGOT), page);
					makeAchievement(AchievementNames.ANGEL_OF_DEATH, mithrilMaker, 11, 11,
							mithril.getItem(Names.SWORD), page);
				}
