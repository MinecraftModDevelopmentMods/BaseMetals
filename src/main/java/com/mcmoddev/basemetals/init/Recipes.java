	...
	protected static void initVanillaRecipes() {
		...
		if (!Options.disableAllHammerRecipes()) {
			if (Options.materialEnabled(MaterialNames.WOOD)) {
				GameRegistry.addRecipe(new ResourceLocation("wood_crackhammer"), new ShapedOreRecipe(new ResourceLocation("wood_crackhammer"), new ItemStack(Materials.getMaterialByName(MaterialNames.WOOD).getItem(Names.CRACKHAMMER)), "x", "/", "/", 'x', Oredicts.LOG_WOOD, '/', Oredicts.STICK_WOOD));
			}
			if (Options.materialEnabled(MaterialNames.STONE)) {
				GameRegistry.addRecipe(new ResourceLocation("stone_crackhammer"), new ShapedOreRecipe(new ResourceLocation("stone_crackhammer"), new ItemStack(Materials.getMaterialByName(MaterialNames.STONE).getItem(Names.CRACKHAMMER)), "x", "/", "/", 'x', net.minecraft.init.Blocks.STONEBRICK, '/', Oredicts.STICK_WOOD));
			}
		}
