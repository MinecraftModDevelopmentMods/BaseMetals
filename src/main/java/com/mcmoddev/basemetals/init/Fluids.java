...
public class Fluids extends com.mcmoddev.lib.init.Fluids {
	...
	public static void init() {
		...
		List<String> vanillaMaterialsMap = Arrays.asList( MaterialNames.CHARCOAL, MaterialNames.COAL, MaterialNames.DIAMOND, 
		...
		List<String> standardMaterialsMap = Arrays.asList( MaterialNames.ADAMANTINE, MaterialNames.ANTIMONY, MaterialNames.AQUARIUM,
		...
		vanillaMaterialsMap.forEach( name -> {
