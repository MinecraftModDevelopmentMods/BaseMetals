...
public final class BMeConfig extends Config {
	...
	private static final MaterialConfigOptions[] MATERIAL_CONFIG_OPTIONS = new MaterialConfigOptions[]{
		...
		new MaterialConfigOptions(MaterialNames.DIAMOND,true, true, true, false),
		new MaterialConfigOptions(MaterialNames.EMERALD,true, true, true, false),
		new MaterialConfigOptions(MaterialNames.GOLD, true,true, true, false),
		new MaterialConfigOptions(MaterialNames.IRON, true,true, true, false),
