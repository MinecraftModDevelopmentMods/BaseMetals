...
public class ToolReturnRecipe extends ShapelessOreRecipe  {
	...
	public ToolReturnRecipe(final ResourceLocation ident, final ItemStack tool, final ItemStack result, final ItemStack... ingredients) {
	...
	public NonNullList<ItemStack> getRemainingItems(final InventoryCrafting inv) {
		final NonNullList<ItemStack> remnants = NonNullList.withSize(inv.getSizeInventory(), ItemStack.EMPTY);
