...
public class MMDMaterial {
	 ...
	 */
	public MMDMaterial addNewItem(final Names name, @Nonnull final Item item) {
	...
	public MMDMaterial addNewItemFromItemStack(final Names name, @Nonnull final ItemStack itemStack) {
	 ...
	 * @return an instance of the material - QOL and call chaining
	 */
	public MMDMaterial addNewBlock(final Names name, @Nullable final Block block) {
		if (block != null) {
