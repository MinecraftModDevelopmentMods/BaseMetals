...
public abstract class Recipes {
	...
	private static void makeBowRecipes(@Nonnull final MMDMaterial material) {
		if (material.hasItem(Names.ARROW)) {
			GameRegistry.addSmelting(new ItemStack(material.getItem(Names.ARROW)),
					new ItemStack(material.getItem(Names.NUGGET), 1), 0); // 0.25 nugget loss
		}

		if (material.hasItem(Names.BOW)) {
			GameRegistry.addSmelting(new ItemStack(material.getItem(Names.BOW)),
					new ItemStack(material.getItem(Names.INGOT), 1), 0); // 4.5 nugget loss
		}
	...
	private static void makeCrossbowRecipes(@Nonnull final MMDMaterial material) {
		if ((material.hasItem(Names.GEAR)) && (material.hasItem(Names.CROSSBOW))) {
			GameRegistry.addSmelting(new ItemStack(material.getItem(Names.CROSSBOW)),
					new ItemStack(material.getItem(Names.INGOT), 2 + Options.gearQuantity()), 0);
		}

		if (material.hasItem(Names.BOLT)) {
			GameRegistry.addSmelting(new ItemStack(material.getItem(Names.BOLT)),
					new ItemStack(material.getItem(Names.NUGGET), 2), 0); // 0.25 nugget loss
		}
	}
	...
	private static void makeNuggetRecipes(@Nonnull final MMDMaterial material) {
		...
		if (material.hasItem(Names.NUGGET)) {
			if (material.hasItem(Names.BUTTON)) {
				GameRegistry.addSmelting(new ItemStack(material.getItem(Names.BUTTON)),
						new ItemStack(material.getItem(Names.NUGGET), 2), 0);
			}
			if (material.hasItem(Names.ROD)) {
				GameRegistry.addSmelting(new ItemStack(material.getItem(Names.ROD)),
						new ItemStack(material.getItem(Names.NUGGET), 4), 0); // Roughly half a nugget loss
			}

			if ((material.hasItem(Names.POWDER)) && (material.hasItem(Names.SMALLPOWDER))) {
				GameRegistry.addSmelting(new ItemStack(material.getItem(Names.SMALLPOWDER)),
						new ItemStack(material.getItem(Names.NUGGET), 1), 0);
				CrusherRecipeRegistry.addNewCrusherRecipe(Oredicts.NUGGET + oreDictName,
						new ItemStack(material.getItem(Names.SMALLPOWDER), 1));
			}
		}
		if (material.hasItem(Names.SMALLBLEND)) {
			GameRegistry.addSmelting(new ItemStack(material.getItem(Names.SMALLBLEND)),
					new ItemStack(material.getItem(Names.NUGGET), 1), 0);
		}
	}
	...
	private static void makeModRecipes(@Nonnull final MMDMaterial material) {
		if (material.hasItem(Names.GEAR) && (material.hasItem(Names.INGOT))) {
			...
			GameRegistry.addSmelting(new ItemStack(material.getItem(Names.GEAR)),
					new ItemStack(material.getItem(Names.INGOT), Options.gearQuantity()), 0); // you lose the rod
		}
	}
		...
		if (material.hasBlock(Names.BLOCK)) {
			if (material.hasItem(Names.SLAB)) {
				GameRegistry.addSmelting(new ItemStack(material.getItem(Names.SLAB)),
						new ItemStack(material.getItem(Names.NUGGET), 4), 0); // you lose roughly half a nugget
			}
			...
			if ((material.hasItem(Names.ROD)) && (material.hasItem(Names.LEVER))) {
				GameRegistry.addSmelting(new ItemStack(material.getItem(Names.LEVER)),
						new ItemStack(material.getItem(Names.INGOT), 1), 0); // you lose the rod
			}

			if (material.hasBlock(Names.WALL)) {
				GameRegistry.addSmelting(new ItemStack(material.getBlock(Names.WALL)),
						new ItemStack(material.getBlock(Names.BLOCK), 1), 0);
			}
			...
			if (material.getBlock(Names.BLOCK) instanceof IMMDObject) {
				...
				if (material.hasBlock(Names.TRAPDOOR)) {
					GameRegistry.addSmelting(new ItemStack(material.getBlock(Names.TRAPDOOR)),
							new ItemStack(material.getItem(Names.INGOT), 4), 0);
				}
				...
				if ((material.getItem(Names.HORSE_ARMOR) instanceof IMMDObject)
					...
					GameRegistry.addSmelting(new ItemStack(material.getItem(Names.HORSE_ARMOR)),
							new ItemStack(material.getItem(Names.INGOT), 6), 0); // 1 wool loss
				}
		...
		if (material.hasItem(Names.INGOT)) {
			if (material.hasOre()) {
				GameRegistry.addSmelting(new ItemStack(material.getBlock(Names.ORE)),
						new ItemStack(material.getItem(Names.INGOT), 1), oreSmeltXP);
			} else if (material.hasBlend()) {
				GameRegistry.addSmelting(new ItemStack(material.getItem(Names.BLEND)),
						new ItemStack(material.getItem(Names.INGOT)), oreSmeltXP);
			}
			...
			if (Options.furnaceCheese()) {
				...
				if (material.hasItem(Names.HELMET))
					GameRegistry.addSmelting(material.getItem(Names.HELMET),
							new ItemStack(material.getItem(Names.INGOT), 5), 0);
				...
				if (material.hasItem(Names.PICKAXE))
					GameRegistry.addSmelting(material.getItem(Names.PICKAXE),
							new ItemStack(material.getItem(Names.INGOT), 3), 0);
	...
	protected static void addAdditionalOredicts(@Nonnull final MMDMaterial material,
		...
		if (material.hasItem(Names.INGOT)) {
			if (material.getType() != MaterialType.GEM) {
				OreDictionary.registerOre(Oredicts.INGOT + oreDictName, material.getItem(Names.INGOT)); // For non-gem
																										// based
