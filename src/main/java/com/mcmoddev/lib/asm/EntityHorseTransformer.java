			...
			if (ITransformer.oneEquals(ENTITY_INIT, name)) {
				return new MethodVisitor(Opcodes.ASM5, mv) {
					...
					public void visitInsn(final int opcode) {
						if (opcode == Opcodes.RETURN) {
							...
							this.mv.visitMethodInsn(INVOKESTATIC, ASMHOOKS_INTERFACE, "onInitHorse",
				...
				return new MethodVisitor(Opcodes.ASM5, mv) {
					...
					public void visitCode() {
						...
						this.mv.visitMethodInsn(INVOKESTATIC, ASMHOOKS_INTERFACE,
								"setHorseArmorStack",
								"(Lnet/minecraft/entity/passive/EntityHorse;Lnet/minecraft/item/ItemStack;)V",
								false);
					}
				};
				...
				return new MethodVisitor(Opcodes.ASM5, mv) {
					...
					public void visitMethodInsn(final int opcode, final String owner,
							final String methodCallName, final String desc, final boolean itf) {
