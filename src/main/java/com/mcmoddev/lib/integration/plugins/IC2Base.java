...
//		Recipes.macerator.addRecipe(new RecipeInputOreDict(Oredicts.ORE + oreDictName, 0), null, false, material.getItemStack(Names.CRUSHED, 2), 2));
//		Recipes.macerator.addRecipe(new RecipeInputOreDict(Oredicts.PLATE_DENSE + oreDictName, 0), null, false, material.getItemStack(Names.POWDER, 8));
