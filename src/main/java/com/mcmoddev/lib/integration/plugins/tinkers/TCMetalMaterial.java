 ...
 * @since 8-FEB-2017
 * 
 *        Wrapper for all the data that the TiC plugin needs to generate a TiC
 *        material and tell TiC how the various parts are to act.
 */
...
public class TCMetalMaterial {
	...
	/**
	 * Add a TiC default or custom trait to the material when used as a specific
	 * tool part
	 * 
	 * @param traitName the AbstractTrait to add
	 * @param loc the MaterialType for the tool part
	 * {@link slimeknights.tconstruct.library.material.MaterialType}
	 * 
	 * @throws
	 */
