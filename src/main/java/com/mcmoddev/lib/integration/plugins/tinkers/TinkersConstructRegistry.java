...
public class TinkersConstructRegistry {
	...
	public TCCode registerBasin(@Nonnull final Block block, @Nonnull final Fluid source,
		...
		TinkerRegistry.registerBasinCasting(new ItemStack(block), ItemStack.EMPTY, source,
				sourceQty);
		return TCCode.SUCCESS;
	}
	...
	public TCCode registerCasting(@Nonnull final Item output, @Nonnull final Fluid source,
		...
		TinkerRegistry.registerTableCasting(new ItemStack(output), ItemStack.EMPTY, source,
				sourceQty);
		return TCCode.SUCCESS;
	}
