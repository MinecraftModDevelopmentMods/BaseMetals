...
public class TCMaterial {
	 ...
	 *            name of the material
	 * @param material
	 *            MetalMaterial that this TCMaterial represents
	 */
	...
	/**
	 * @param headDurability
	 *            durability of material when used as a tool head
	 * @return the material
	 */
	...
	/**
	 * @param bodyDurability
	 *            durability of material when used as a tool rod/body
	 * @return the material
	 */
	...
	/**
	 * @param miningSpeed
	 *            Speed of mining with this material
	 * @return the material
	 */
	...
	/**
	 * @param headAttackDamage
	 *            Attack damage when used as a tool/weapon head
	 * @return the material
	 */
	...
	/**
	 * @param bodyModifier
	 *            Modifier amount applied when used for a tool/weapon body
	 * @return the material
	 */
	...
	/**
	 * @param bowDrawingSpeed
	 *            draw speed of bows made from this material
	 * @return the material
	 */
	...
	/**
	 * @param bowRange
	 *            range of bows made from this material
	 * @return the material
	 */
	...
	/**
	 * @param bowDamage
	 *            base damage of bows made from this material
	 * @return the material
	 */
	...
	/**
	 * @param bowstringModifier
	 *            Modifier when this material is used to make a bow string
	 * @return the material
	 */
	...
	/**
	 * @param shaftModifier
	 *            Modifier when used as bolt/arrow shaft
	 * @return the material
	 */
	...
	/**
	 * @param fletchingAccuracy
	 *            accuracy modifier when material is used to make fletching
	 * @return the material
	 */
	...
	/**
	 * @param fletchingMod
	 *            base modifier when used as fletching
	 * @return the material
	 */
	...
	/**
	 * @param toolForge
	 *            is this material capable of being a ToolForge base material ?
	 * @return the material
	 */
