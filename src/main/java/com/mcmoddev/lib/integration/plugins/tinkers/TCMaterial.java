...
public class TCMaterial {
	...
	private TCMaterial(final String name) {
		this();
		this.name = name;
	}

	private TCMaterial(final String name, final int color) {
		this(name);
	 ...
	 * @param material
	 */
	public TCMaterial(final MMDMaterial material) {
		this();
		this.material = material;
		this.genStatsInternal();
	}

	public TCMaterial(final MMDMaterial material, final String name) {
		this(material);
		this.name = name;
	}

	public TCMaterial(final MMDMaterial material, final String name, final int color) {
		this(material, name);
		this.tintColor = color;
	}
	 ...
	 * @return
	 */
	public TCMaterial setHeadStats(final HeadMaterialStats headStats) {
	 ...
	 * @return
	 */
	public TCMaterial setHandleStats(final HandleMaterialStats handleStats) {
	 ...
	 * @return
	 */
	public TCMaterial setExtraStats(final ExtraMaterialStats extraStats) {
	 ...
	 * @return
	 */
	public TCMaterial setBowStats(final BowMaterialStats bowStats) {
	...
	/**
	 *
	 * @param bowStringStats
	 * @return
	 */
	public TCMaterial setBowStringStats(final BowStringMaterialStats bowStringStats) {
	...
	/**
	 *
	 * @param fletchingStats
	 * @return
	 */
	public TCMaterial setFletchingStats(final FletchingMaterialStats fletchingStats) {
	 ...
	 * @return
	 */
	public TCMaterial setRepresentativeItem(@Nullable final String itemName) {
