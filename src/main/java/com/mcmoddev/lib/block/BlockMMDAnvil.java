...
public class BlockMMDAnvil extends net.minecraft.block.BlockAnvil implements IMMDObject {
	 ...
	 */
	@Override
	public boolean onBlockActivated(final World worldIn, final BlockPos pos, final IBlockState state, final EntityPlayer playerIn, final EnumHand hand, final ItemStack itemStack, final EnumFacing facing, final float hitX, final float hitY, final float hitZ) {
		if (!worldIn.isRemote) {
