...
public class InteractiveFluidBlock extends BlockFluidClassic {
	 ...
	 */
	public InteractiveFluidBlock(Fluid fluid, boolean flammable, BiConsumer<net.minecraft.world.World, net.minecraft.entity.EntityLivingBase> immersionEffect) {
	 ...
	 * @param immersionEffect A function to define what happens to swimming entities. Can be null.
	 */
	public InteractiveFluidBlock(Fluid fluid, BiConsumer<net.minecraft.world.World, net.minecraft.entity.EntityLivingBase> immersionEffect) {
